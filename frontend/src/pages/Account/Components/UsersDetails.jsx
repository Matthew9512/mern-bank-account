export const UsersDetails = ({ data }) => {
   return (
      <>
         <div className='w-80 bg-light-green text-white rounded-lg relative mt-16 h-48'>
            {/* <div className='w-80 bg-blue rounded-lg relative h-48 mt-8'> */}
            ...
            <p className='absolute top-6 right-6 tracking-wide text-lg font-bold'>$ {data?.totalMoney}</p>
